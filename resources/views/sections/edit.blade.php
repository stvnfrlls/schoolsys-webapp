<x-app-layout>
    ...
    @section('breadcrumb', 'Update section details')
    ...
    <div class="bg-white rounded-xl border border-slate-200 max-w-2xl">
        ...
        <div class="px-6 py-5 border-b border-slate-100">
            <div class="flex items-start justify-between">
                <div>
                    <h2 class="text-sm font-semibold text-slate-800 font-sans">Edit Section — {{ $section->name }}</h2>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button form="edit-section-form" type="submit"
        ...
        {{-- Form --}}
        <form id="edit-section-form" action="{{ route('sections.update', $section) }}" method="POST"
            class="p-6 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="flex items-center gap-6">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input
                            ...
                            name="is_active"
                            value="active"
                            {{ old('is_active', $section->is_active) === 'active' ? 'checked' : '' }}
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input
                            ...
                            name="is_active"
                            value="inactive"
                            {{ old('is_active', $section->is_active) === 'inactive' ? 'checked' : '' }}
                            class="w-4 h-4 text-school-600 border-slate-300 focus:ring-2 focus:ring-school-600">
            ...
            <div class="pt-4 border-t border-slate-100">
                <button type="button" onclick="document.getElementById('delete-section-form').submit()"
        ...
        {{-- Hidden delete form --}}
        <form id="delete-section-form" action="{{ route('sections.destroy', $section) }}" method="POST"
