<x-app-layout>
    ...
    @section('breadcrumb', 'Manage sections and their assignments')
    ...
    <div class="bg-white rounded-xl border border-slate-200">
        ...
        <div class="flex flex-col gap-4 px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-100">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-sm font-semibold text-slate-800 font-sans">All Sections</h2>
                    <p class="text-xs text-slate-400 mt-0.5">Sections and their status</p>
                </div>
                ...
                <a href="{{ route('sections.create') }}"
                    ...
                    <span class="max-sm:hidden">New Section</span>
            ...
            <div id="search-export-row" class="flex flex-col gap-2 md:flex-row md:items-center justify-between">
                <div class="flex items-center gap-2 md:ml-auto">
                    ...
                    <div class="relative flex-1 md:flex-none">
                        ...
                        <input id="sections-search" type="text" placeholder="Search sections..."
        ...
        <div class="overflow-x-auto px-4 sm:px-6 py-4">
            {{ $dataTable->table(['class' => 'w-full text-sm sections-dt text-center']) }}
        </div>
    ...
    @push('styles')
        ...
        <style>
            ...
            #section-table_length select:focus {
                outline: none;
                border-color: #1e3a8a;
            ...
            /* Header */
            table.sections-dt thead tr {
                background-color: #f8fafc;
                border-bottom: 1px solid #e2e8f0;
            }

            table.sections-dt thead th,
            table.dataTable td {
                font-size: 0.7rem;
                font-weight: 600;
            ...
            /* Body rows */
            table.sections-dt tbody tr {
                border-bottom: 1px solid #f1f5f9;
                transition: background-color 0.1s;
            }

            table.sections-dt tbody tr:hover {
                background-color: #f8fafc !important;
            }

            table.sections-dt tbody tr:last-child {
                border-bottom: none;
            }

            table.sections-dt tbody td {
            ...
            table.sections-dt tbody tr.child td {
                padding: 0.5rem 1rem !important;
                background: #f8fafc;
                text-align: left !important;
            }

            table.sections-dt tbody tr.child ul.dtr-details {
                display: block;
                width: 100%;
                margin: 0;
                padding: 0;
            ...
            table.sections-dt tbody tr.child ul.dtr-details li {
                display: flex;
            ...
            table.sections-dt tbody tr.child ul.dtr-details li:last-child {
                border-bottom: none;
            }

            table.sections-dt tbody tr.child ul.dtr-details li span.dtr-title {
                font-weight: 600;
                color: #64748b;
                text-transform: uppercase;
            ...
            table.sections-dt tbody tr.child ul.dtr-details li span.dtr-data {
                color: #475569;
            }

            /* Pagination */
            #section-table_paginate {
            ...
            #section-table_paginate .paginate_button {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-width: 2rem;
            ...
            #section-table_paginate .paginate_button:hover {
                background-color: #f1f5f9 !important;
                color: #1e40af !important;
            }

            #section-table_paginate .paginate_button.current {
                background-color: #1e3a8a !important;
                color: #fff !important;
                font-weight: 600;
            }

            #section-table_paginate .paginate_button.disabled {
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                $('#section-table').on('init.dt', function () {
                    const table = $('#section-table').DataTable();
                    const $length = $('#section-table_length').detach();
                    $('#search-export-row').prepend($length);

                    // Wire custom search input
                    document.getElementById('sections-search').addEventListener('input', function () {
