<x-app-layout>
    ...
    @section('breadcrumb', 'Manage student enrollments per school year')
    ...
    <div class="bg-white rounded-xl border border-slate-200">
        ...
        <div class="flex flex-col gap-4 px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-100">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-sm font-semibold text-slate-800 font-sans">All Enrollments</h2>
                    <p class="text-xs text-slate-400 mt-0.5">Student enrollments with their assigned sections and school
                        years</p>
                </div>
                ...
                <a href="{{ route('enrollments.create') }}"
                    ...
                    <span class="max-sm:hidden">New Enrollment</span>
            ...
            <div id="search-export-row" class="flex flex-col gap-2 md:flex-row md:items-center justify-between">
                <div class="flex items-center gap-2 md:ml-auto">
                    ...
                    <div class="relative flex-1 md:flex-none">
                        ...
                        <input id="enrollments-search" type="text" placeholder="Search enrollments..."
        ...
        <div class="overflow-x-auto px-4 sm:px-6 py-4">
            {{ $dataTable->table(['class' => 'w-full text-sm enrollments-dt text-center']) }}
        </div>
    ...
    @push('styles')
        ...
        <style>
            #enrollments-table_filter,
            .dt-buttons {
                display: none !important;
            }

            #enrollments-table_length {
                display: flex;
                align-items: center;
                gap: 0.5rem;
                font-size: 0.75rem;
            ...
            #enrollments-table_length label {
                display: flex;
                align-items: center;
                gap: 0.5rem;
                font-size: 0.75rem;
            ...
            #enrollments-table_length select {
                appearance: none;
            ...
            #enrollments-table_length select:focus {
                outline: none;
                border-color: #1e3a8a;
                box-shadow: 0 0 0 2px rgba(30, 58, 138, 0.15);
            }

            table.enrollments-dt {
                border-collapse: collapse;
                width: 100% !important;
            }

            table.enrollments-dt thead tr {
                background-color: #f8fafc;
                border-bottom: 1px solid #e2e8f0;
            }

            table.enrollments-dt thead th,
            table.dataTable td {
                font-size: 0.7rem;
                font-weight: 600;
            ...
            table.enrollments-dt tbody tr {
                border-bottom: 1px solid #f1f5f9;
                transition: background-color 0.1s;
            }

            table.enrollments-dt tbody tr:hover {
                background-color: #f8fafc !important;
            }

            table.enrollments-dt tbody tr:last-child {
                border-bottom: none;
            }

            table.enrollments-dt tbody td {
            ...
            table.enrollments-dt tbody tr.child td {
                padding: 0.5rem 1rem !important;
                background: #f8fafc;
                text-align: left !important;
            }

            table.enrollments-dt tbody tr.child ul.dtr-details {
                display: block;
                width: 100%;
                margin: 0;
                padding: 0;
            ...
            table.enrollments-dt tbody tr.child ul.dtr-details li {
                display: flex;
            ...
            table.enrollments-dt tbody tr.child ul.dtr-details li:last-child {
                border-bottom: none;
            }

            table.enrollments-dt tbody tr.child ul.dtr-details li span.dtr-title {
                font-weight: 600;
                color: #64748b;
                text-transform: uppercase;
            ...
            table.enrollments-dt tbody tr.child ul.dtr-details li span.dtr-data {
                color: #475569;
            }

            #enrollments-table_paginate {
            ...
            #enrollments-table_paginate .paginate_button {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-width: 2rem;
            ...
            #enrollments-table_paginate .paginate_button:hover {
                background-color: #f1f5f9 !important;
                color: #1e40af !important;
            }

            #enrollments-table_paginate .paginate_button.current {
                background-color: #1e3a8a !important;
                color: #fff !important;
                font-weight: 600;
            }

            #enrollments-table_paginate .paginate_button.disabled {
                color: #cbd5e1 !important;
                cursor: not-allowed;
            }

            #enrollments-table_info {
                padding: 0.75rem 1rem;
                font-size: 0.75rem;
                color: #94a3b8;
                border-top: 1px solid #f1f5f9;
    ...
    @push('scripts')
        ...
        <script>
            ...
            waitForTable('enrollments-table', function (table) {
                const $length = $('#enrollments-table_length').detach();
                $('#search-export-row').prepend($length);

                document.getElementById('enrollments-search').addEventListener('input', function () {
