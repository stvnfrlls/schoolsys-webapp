        ...
        <div class="flex flex-col gap-4 px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-100">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-0.5">Student enrollments with their assigned sections and school years</p>
                </div>
                ...
                <a href="{{ route('enrollments.create') }}"
                    ...
                    <span class="hidden sm:inline">New Enrollment</span>
