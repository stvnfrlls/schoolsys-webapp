            ...
            <div class="p-6">
                <div class="max-w-md flex flex-col gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700
                    ...
                    <div>
                        ...
                        <input type="text" name="guard_name" value="{{ old('guard_name', 'web') }}" class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-700
                                   focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        @error('guard_name')
                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
