<x-app-layout>
    ...
    @section('breadcrumb', 'Manage class schedules by section, subject, and faculty')
    ...
    <div class="bg-white rounded-xl border border-slate-200">
        ...
        <div class="flex flex-col gap-4 px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-100">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-0.5">Class schedules grouped by section, subject, and assigned
                        faculty</p>
                </div>
            ...
            <div id="search-export-row" class="flex flex-col gap-2 md:flex-row md:items-center justify-between">
                <div class="flex items-center gap-2 md:ml-auto">
                    ...
                    <div class="relative flex-1 md:flex-none">
                        ...
                        <input id="schedules-search" type="text" placeholder="Search schedules..."
        ...
        <div class="overflow-x-auto px-4 sm:px-6 py-4">
            {{ $dataTable->table(['class' => 'w-full text-sm schedules-dt text-center']) }}
        </div>
    ...
    @push('styles')
        ...
        <style>
            #schedules-table_filter,
            .dt-buttons {
                display: none !important;
            }

            #schedules-table_length {
                display: flex;
                align-items: center;
                gap: 0.5rem;
                font-size: 0.75rem;
            ...
            #schedules-table_length select:focus {
                outline: none;
                border-color: #1e3a8a;
            ...
            table.schedules-dt thead tr {
                background-color: #f8fafc;
                border-bottom: 1px solid #e2e8f0;
            }

            table.schedules-dt thead th,
            table.schedules-dt td {
                font-size: 0.7rem;
                font-weight: 600;
            ...
            table.schedules-dt tbody tr:hover {
                background-color: #f8fafc !important;
            }

            table.schedules-dt tbody tr:last-child {
                border-bottom: none;
            }

            table.schedules-dt tbody td {
            ...
            table.schedules-dt tbody tr.child td {
                padding: 0.5rem 1rem !important;
                background: #f8fafc;
                text-align: left !important;
            }

            table.schedules-dt tbody tr.child ul.dtr-details {
                display: block;
                width: 100%;
                margin: 0;
                padding: 0;
            ...
            table.schedules-dt tbody tr.child ul.dtr-details li {
                display: flex;
            ...
            table.schedules-dt tbody tr.child ul.dtr-details li:last-child {
                border-bottom: none;
            }

            table.schedules-dt tbody tr.child ul.dtr-details li span.dtr-title {
                font-weight: 600;
                color: #64748b;
                text-transform: uppercase;
            ...
            table.schedules-dt tbody tr.child ul.dtr-details li span.dtr-data {
                color: #475569;
            }

            #schedules-table_paginate {
            ...
            #schedules-table_paginate .paginate_button {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-width: 2rem;
            ...
            #schedules-table_paginate .paginate_button:hover {
                background-color: #f1f5f9 !important;
                color: #1e40af !important;
            }

            #schedules-table_paginate .paginate_button.current {
                background-color: #1e3a8a !important;
                color: #fff !important;
                font-weight: 600;
            }

            #schedules-table_paginate .paginate_button.disabled {
                color: #cbd5e1 !important;
                cursor: not-allowed;
            }

            #schedules-table_info {
                padding: 0.75rem 1rem;
                font-size: 0.75rem;
                color: #94a3b8;
                border-top: 1px solid #f1f5f9;
