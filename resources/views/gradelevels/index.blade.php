<x-app-layout>
    @section('page-title', 'Grade Level')
    @section('breadcrumb', 'Manage system gradelevels and their roles')
    ...
    <div class="bg-white rounded-xl border border-slate-200">
        ...
        <div class="flex flex-col gap-4 px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-100">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-sm font-semibold text-slate-800 font-sans">All Grade Levels</h2>
                    <p class="text-xs text-slate-400 mt-0.5">System gradelevels with their assigned roles and status</p>
                </div>
        ...
        <div class="overflow-x-auto px-4 sm:px-6 py-4">
            {{ $dataTable->table(['class' => 'w-full text-sm gradelevels-dt text-center']) }}
        </div>
    ...
    @push('styles')
        ...
        <style>
            ...
            #gradelevels-table_length select {
                appearance: none;
            ...
            #gradelevels-table_length select:focus {
                outline: none;
                border-color: #1e3a8a;
            ...
            /* Table base */
            table.gradelevels-dt {
                border-collapse: collapse;
                width: 100% !important;
            }

            /* Header */
            table.gradelevels-dt thead tr {
                background-color: #f8fafc;
                border-bottom: 1px solid #e2e8f0;
            }

            table.gradelevels-dt thead th,
            table.dataTable td {
                font-size: 0.7rem;
                font-weight: 600;
            ...
            /* Body rows */
            table.gradelevels-dt tbody tr {
                border-bottom: 1px solid #f1f5f9;
                transition: background-color 0.1s;
            }

            table.gradelevels-dt tbody tr:hover {
                background-color: #f8fafc !important;
            }

            table.gradelevels-dt tbody tr:last-child {
                border-bottom: none;
            }

            table.gradelevels-dt tbody td {
            ...
            table.gradelevels-dt tbody tr.child td {
                padding: 0.5rem 1rem !important;
                background: #f8fafc;
                text-align: left !important;
            }

            table.gradelevels-dt tbody tr.child ul.dtr-details {
                display: block;
                width: 100%;
                margin: 0;
                padding: 0;
            ...
            table.gradelevels-dt tbody tr.child ul.dtr-details li {
                display: flex;
            ...
            table.gradelevels-dt tbody tr.child ul.dtr-details li:last-child {
                border-bottom: none;
            }

            table.gradelevels-dt tbody tr.child ul.dtr-details li span.dtr-title {
                font-weight: 600;
                color: #64748b;
                text-transform: uppercase;
            ...
            table.gradelevels-dt tbody tr.child ul.dtr-details li span.dtr-data {
                color: #475569;
            }
            ...
            #gradelevels-table_paginate .paginate_button {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-width: 2rem;
            ...
            #gradelevels-table_paginate .paginate_button:hover {
                background-color: #f1f5f9 !important;
                color: #1e40af !important;
            }

            #gradelevels-table_paginate .paginate_button.current {
                background-color: #1e3a8a !important;
                color: #fff !important;
                font-weight: 600;
            }

            #gradelevels-table_paginate .paginate_button.disabled {
                color: #cbd5e1 !important;
                cursor: not-allowed;
            }

            /* Info text */
            #gradelevels-table_info {
                padding: 0.75rem 1rem;
                font-size: 0.75rem;
                color: #94a3b8;
                border-top: 1px solid #f1f5f9;
    ...
    @push('scripts')
        ...
        <script>
            ...
            waitForTable('gradelevels-table', function (table) {
                const $length = $('#gradelevels-table_length').detach();
                $('#search-export-row').prepend($length);

                document.getElementById('gradelevels-search').addEventListener('input', function () {
