<x-app-layout>
    ...
    @section('breadcrumb', 'Add a new student record')
        ...
        <form action="{{ route('students.store') }}" method="POST">
            ...
            <div class="px-6 py-5 border-b border-slate-100">
                <div class="flex items-start justify-between">
                    <div>
                        <h2 class="text-sm font-semibold text-slate-800 font-sans">New Student</h2>
                        <p class="text-xs text-slate-400 mt-0.5">Fill in the details below to enroll a new student</p>
                    </div>
                    ...
                    <div class="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="guardian_relationship" name="guardian_relationship"
                                value="{{ old('guardian_relationship') }}" placeholder="Mother, Father, Sibling..."
