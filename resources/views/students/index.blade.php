<x-app-layout>
    ...
    @section('breadcrumb', 'Manage students and their records')
    ...
    <div class="bg-white rounded-xl border border-slate-200">
        ...
        <div class="flex flex-col gap-4 px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-100">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-sm font-semibold text-slate-800 font-sans">All Students</h2>
                    <p class="text-xs text-slate-400 mt-0.5">Students and their enrollment status</p>
                </div>
                ...
                <a href="{{ route('students.create') }}"
                    ...
                    <span class="max-sm:hidden">New Student</span>
            ...
            <div id="search-export-row" class="flex flex-col gap-2 md:flex-row md:items-center justify-between">
                <div class="flex items-center gap-2 md:ml-auto">
                    ...
                    <div class="relative flex-1 md:flex-none">
                        ...
                        <input id="students-search" type="text" placeholder="Search students..."
        ...
        <div class="overflow-x-auto px-4 sm:px-6 py-4">
            {{ $dataTable->table(['class' => 'w-full text-sm students-dt text-center']) }}
        </div>
    ...
    @push('styles')
        ...
        <style>
            ...
            #students-table_length select:focus {
                outline: none;
                border-color: #1e3a8a;
            ...
            table.students-dt thead tr {
                background-color: #f8fafc;
                border-bottom: 1px solid #e2e8f0;
            }

            table.students-dt thead th,
            table.students-dt td {
                font-size: 0.7rem;
                font-weight: 600;
            ...
            table.students-dt tbody tr {
                border-bottom: 1px solid #f1f5f9;
                transition: background-color 0.1s;
            }

            table.students-dt tbody tr:hover {
                background-color: #f8fafc !important;
            }

            table.students-dt tbody tr:last-child {
                border-bottom: none;
            }

            table.students-dt tbody td {
            ...
            table.students-dt tbody tr.child td {
                padding: 0.5rem 1rem !important;
                background: #f8fafc;
                text-align: left !important;
            }

            table.students-dt tbody tr.child ul.dtr-details {
                display: block;
                width: 100%;
                margin: 0;
                padding: 0;
            ...
            table.students-dt tbody tr.child ul.dtr-details li {
                display: flex;
            ...
            table.students-dt tbody tr.child ul.dtr-details li:last-child {
                border-bottom: none;
            }

            table.students-dt tbody tr.child ul.dtr-details li span.dtr-title {
                font-weight: 600;
                color: #64748b;
                text-transform: uppercase;
            ...
            table.students-dt tbody tr.child ul.dtr-details li span.dtr-data {
                color: #475569;
            }

            #students-table_paginate {
            ...
            #students-table_paginate .paginate_button {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-width: 2rem;
            ...
            #students-table_paginate .paginate_button:hover {
                background-color: #f1f5f9 !important;
                color: #1e40af !important;
            }

            #students-table_paginate .paginate_button.current {
                background-color: #1e3a8a !important;
                color: #fff !important;
                font-weight: 600;
            }

            #students-table_paginate .paginate_button.disabled {
    ...
    @push('scripts')
        ...
        <script>
            ...
            waitForTable('students-table', function (table) {
                const $length = $('#students-table_length').detach();
