<x-app-layout>
    ...
    @section('breadcrumb', 'Manage system school years and their active status')
    ...
    <div class="bg-white rounded-xl border border-slate-200">
        ...
        <div class="flex flex-col gap-4 px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-100">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-sm font-semibold text-slate-800 font-sans">All School Years</h2>
                    <p class="text-xs text-slate-400 mt-0.5">System school years with their date ranges and active
                        status</p>
                </div>
                ...
                <a href="{{ route('schoolyears.create') }}"
                    ...
                    <span class="hidden sm:inline">New School Year</span>
            ...
            <div id="search-export-row" class="flex flex-col gap-2 md:flex-row md:items-center justify-between">
                <div class="flex items-center gap-2 md:ml-auto">
                    ...
                    <div class="relative flex-1 md:flex-none">
                        ...
                        <input id="schoolyears-search" type="text" placeholder="Search school years..."
        ...
        <div class="overflow-x-auto px-4 sm:px-6 py-4">
            {{ $dataTable->table(['class' => 'w-full text-sm schoolyears-dt text-center']) }}
        </div>
    ...
    @push('styles')
        ...
        <style>
            ...
            #schoolyears-table_filter,
            .dt-buttons {
                display: none !important;
            }

            #schoolyears-table_length {
                display: flex;
                align-items: center;
                gap: 0.5rem;
                font-size: 0.75rem;
            ...
            #schoolyears-table_length label {
                display: flex;
                align-items: center;
                gap: 0.5rem;
                font-size: 0.75rem;
            ...
            #schoolyears-table_length select {
                appearance: none;
            ...
            #schoolyears-table_length select:focus {
                outline: none;
                border-color: #1e3a8a;
            ...
            /* Table base */
            table.schoolyears-dt {
                border-collapse: collapse;
                width: 100% !important;
            }

            /* Header */
            table.schoolyears-dt thead tr {
                background-color: #f8fafc;
                border-bottom: 1px solid #e2e8f0;
            }

            /* ✅ Fixed: was `table.schoolyears-dt td` (missed thead th styling) */
            table.schoolyears-dt thead th,
            table.dataTable td {
                font-size: 0.7rem;
                font-weight: 600;
            ...
            /* Body rows */
            table.schoolyears-dt tbody tr {
                border-bottom: 1px solid #f1f5f9;
                transition: background-color 0.1s;
            }

            table.schoolyears-dt tbody tr:hover {
                background-color: #f8fafc !important;
            }

            table.schoolyears-dt tbody tr:last-child {
                border-bottom: none;
            }

            table.schoolyears-dt tbody td {
            ...
            table.schoolyears-dt tbody tr.child td {
                padding: 0.5rem 1rem !important;
                background: #f8fafc;
                text-align: left !important;
            }

            table.schoolyears-dt tbody tr.child ul.dtr-details {
                display: block;
                width: 100%;
                margin: 0;
                padding: 0;
            ...
            table.schoolyears-dt tbody tr.child ul.dtr-details li {
                display: flex;
            ...
            table.schoolyears-dt tbody tr.child ul.dtr-details li:last-child {
                border-bottom: none;
            }

            table.schoolyears-dt tbody tr.child ul.dtr-details li span.dtr-title {
                font-weight: 600;
                color: #64748b;
                text-transform: uppercase;
            ...
            table.schoolyears-dt tbody tr.child ul.dtr-details li span.dtr-data {
                color: #475569;
            }

            /* Pagination */
            #schoolyears-table_paginate {
            ...
            #schoolyears-table_paginate .paginate_button {
                display: inline-flex;
                align-items: center;
                justify-content: center;
                min-width: 2rem;
            ...
            #schoolyears-table_paginate .paginate_button:hover {
                background-color: #f1f5f9 !important;
                color: #1e40af !important;
            }

            #schoolyears-table_paginate .paginate_button.current {
                background-color: #1e3a8a !important;
                color: #fff !important;
                font-weight: 600;
            }

            #schoolyears-table_paginate .paginate_button.disabled {
                color: #cbd5e1 !important;
                cursor: not-allowed;
            }

            /* Info text */
            #schoolyears-table_info {
                padding: 0.75rem 1rem;
                font-size: 0.75rem;
                color: #94a3b8;
                border-top: 1px solid #f1f5f9;
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                $('#schoolyears-table').on('init.dt', function () {
                    const table = $('#schoolyears-table').DataTable();

                    // Move length select into search-export row
                    const $length = $(' #schoolyears-table_length').detach();
                    $('#search-export-row').prepend($length);

                    // Wire custom search input
                    document.getElementById('schoolyears-search').addEventListener('input', function () {
